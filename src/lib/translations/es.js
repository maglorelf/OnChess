...
const spanishTranslations = {
  ...
  auth: {
    ...
    signInToYourAccount: 'Inicia sesión en tu cuenta', // Added new key
    ...
    passwordPlaceholderMinChars: 'Contraseña (mínimo 8 caracteres)',
  ...
  errors: {
    ...
    loginGeneric: 'Error al iniciar sesión', // Added new key
    loginErrorGeneric: 'Ocurrió un error durante el inicio de sesión', // Added new key
    register: 'Error en el registro. Por favor, inténtalo de nuevo.',
    registerGeneric: 'Ocurrió un error durante el registro',
